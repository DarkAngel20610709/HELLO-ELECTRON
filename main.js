...
win.on('close', (event) => {
    event.preventDefault();// it stop the window a=from the actualy closing 
...

    {
        ...
        submenu: [
            ...
            },
            {
                ...
                click: () => {
                    const win = BrowserWindows.getFocusedWindow();
            ...
            },
            {
                ...
                click: () => {
                    const win = BrowserWindows.getFocusedWindows();
...
// i=this ine helps to  get  the nottes from the json file and send it to the renderer 
